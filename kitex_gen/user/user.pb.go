...
type DouyinUserLoginRequest struct {
	...
	Username string `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"` // 登录用户名，最长32个字符
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // 密码，最长32个字符
}
...
type DouyinUserRequest struct {
	...
	MyId  int64 `protobuf:"varint,1,opt,name=my_id,json=myId,proto3" json:"my_id,omitempty"`    // 用户id
	HisId int64 `protobuf:"varint,2,opt,name=his_id,json=hisId,proto3" json:"his_id,omitempty"` // 目标id
}
...
func (x *DouyinUserRequest) GetHisId() int64 {
	if x != nil {
		return x.HisId
	}
	return 0
...
var file_user_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x6d, 0x73, 0x67, 0x22, 0x41, 0x0a, 0x13, 0x64, 0x6f,
	...
	0x52, 0x04, 0x6d, 0x79, 0x49, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x68, 0x69, 0x73, 0x5f, 0x69, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x68, 0x69, 0x73, 0x49, 0x64, 0x22, 0x8a, 0x01,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x88, 0x01, 0x01, 0x12, 0x1e, 0x0a, 0x04, 0x75,
	...
	0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xfb, 0x01, 0x0a,
	0x07, 0x55, 0x73, 0x65, 0x72, 0x53, 0x72, 0x76, 0x12, 0x59, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72,
	...
	0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x09, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x73, 0x65, 0x72, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f,
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x1e, 0x5a, 0x1c, 0x6b, 0x69,
	0x74, 0x65, 0x78, 0x64, 0x6f, 0x75, 0x73, 0x68, 0x65, 0x6e, 0x67, 0x2f, 0x6b, 0x69, 0x74, 0x65,
...
var file_user_proto_depIdxs = []int32{
	...
	0, // 1: user.UserSrv.UserRegister:input_type -> user.douyin_user_register_request
	2, // 2: user.UserSrv.UserLogin:input_type -> user.douyin_user_login_request
	4, // 3: user.UserSrv.UserInfo:input_type -> user.douyin_user_request
	1, // 4: user.UserSrv.UserRegister:output_type -> user.douyin_user_register_response
	3, // 5: user.UserSrv.UserLogin:output_type -> user.douyin_user_login_response
	5, // 6: user.UserSrv.UserInfo:output_type -> user.douyin_user_response
